...
@if($comments->count() < 1)
    <div class="alert alert-warning">Zatiaľ bez komentárov</div>
@endif
...
@else
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">Autentifikácia žiadaná</h5>
            <p class="card-text">Musíš sa prihlásiť aby si nám mohol povedať svoj názor</p>
